...
const EditProfile = ({user, setIsAuthenticated, setUser, checked, setChecked, setCourse}) => {
    ...
    const [header, setHeader] = useState('Edit Profile');
    ...
    useEffect(()=>{
        ...
        if(user.phone){
            ...
            setHeader('Complete your profile to contact you');
            ...
            .then(res=>{
                ...
                if(res.data.message === "success"){
                    ...
                    if(res.data.subscribe){
                        navigate("/home/oauth/success/subscribe");
                    }
                    else{
