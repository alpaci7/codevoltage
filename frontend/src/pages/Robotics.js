                ...
                <div className="course-container">
                    ...
                    <div className="course-objectif-images">
                        ...
                        <div className="images-container">
                            ...
                            <div className="image2 rotate"><img src={arduinoSchematic} alt="Arduino Schematic"></img></div>
                            <div ref={unStickRef} className="image3 rotate"><img src={arduinoCircuit} alt="Arduino Circuit"></img></div>
                                ...
                                <div className="content-part4">
                                    <div className="third-month">
                                        ...
                                        <ol className="ol">
                                            ...
                                            <li ref={bottomStickRef}><p>{t('Parking Intélligent')}</p></li>
                                            <li ref={bottomUnStickRef}><p>{t('Maison Intélligente')}</p></li>
