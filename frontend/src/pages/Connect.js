...
const Connect = ({STATUS, setUser, setIsAuthenticated, MESSAGE, checked, setChecked, COURSE, setCourse}) => {
    ...
    },[STATUS, MESSAGE, t, checked, COURSE, setCourse, course]);
            ...
            .then((res)=>{
                ...
                if(res.data.message === "success"){
                    ...
                    if(res.data.subscribe){
                        navigate('/home/success/subscribe');
                        ...
                        <div className="form-children">
                                ...
                                <div className="google-auth">
                                    ...
                                    <Button
                                        ...
                                        $HoverBackgroundColor="var(--form-background)" 
                                        $BorderRadius="30px"
                                        $Border = "3px solid #ccc"
                                        $Color="var(--color)"
                                        $HoverColor="var(--hover-color)"
                                        onClick={()=>{
                                            window.location.href = `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&redirect_uri=${process.env.REACT_APP_REDIRECT_URI}/auth/google/redirect&scope=profile+email&client_id=${process.env.REACT_APP_GOOGLE_CLIENT_ID}&state=${COURSE}`;
                ...
                :
                    <div className="form">
                        ...
                        <Form onSubmit={handleSignup}>
                            ...
                            <div className="form-children">
                                <Label ref={bottomRef}>{t('Date Of Birth')} :</Label>
                            ...
                            <div className="form-buttons">
                                <Button  style={{ marginTop: '20px' }} type="submit" $BorderRadius="5px">{t('Sign Up')}</Button>
