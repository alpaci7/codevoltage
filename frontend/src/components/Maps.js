    ...
    return (
        ...
        <div className="maps-field">
            <div className="maps-card"> 
                <Button title="30 ile verte tit mellil mediouna casablanca" disabled={local1} onClick={()=>Local1()}>{t('Local 1')}</Button>
                <Button title="30 ile verte maârif casablanca" disabled={local2} onClick={()=>Local2()}>{t('Local 2')}</Button>
                <Button title="30 ile verte maârif casablanca" disabled={local3} onClick={()=>Local3()}>{t('Local 3')}</Button>
